...
var ConversationPanel = (function() {
        ...
        if (index < responses.length) {
            if (!flag) {
                ...
                if (res.type !== 'pause') {
                    ...
                    if (res.typing) {
                        userTypringField.innerHTML = 'Request is in Progress...';
                    }
                    setTimeout(function() {
            ...
            if (responses.length != 0) {
                if (responses[0].innerhtml == "Please wait your claim is being created") {
    ...
    function buildSearchResultPage(searchAction, actionToken) {
        ...
        var url = '/search?searchAction=' + searchAction + '&token=' + actionToken + '&claimNumber=' + claimNumber;
